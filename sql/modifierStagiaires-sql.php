...
$sql = "UPDATE stagiaires SET nom = :nom, prenom = :prenom, email = :email, tel = :tel, adresse = :adresse, entrer = :entrer, naissance = :naissance, formation = :formation, photo = :photo, formateur = :formateur WHERE id= :id";
