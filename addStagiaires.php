...
if (!empty($_POST["submited"])) {
    ...
    // //4- if no error
    if (count($error) == 0) {
        require_once("sql/addStagiaire-sql.php");
    }
}
        ...
        <- retour </a>
            ...
            <form action="" method="POST" class="grid place-items-center bg-gray-100 mx-96 py-10 my-16 gap-y-4 rounded-xl" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="naissance" class="input input-bordered w-full max-w-xs block" value="<?php
                ...
                <div class="mb-4 flex space-x-6">
                    <?php foreach ($formateurArray as $formateur) : ?>
                        <div class="flex item-center space-x-3">
                            ...
                            <input type="checkbox" class="checkbox checkbox-primary bg-white" name="formateur[]" value="<?= $formateur["name"] ?>" <?php if (!empty($_POST["formateur"])) {
                                                                                                                                                        if (in_array($formateur["name"], $_POST["formateur"])) echo "checked";
                                                                                                                                                    } ?> />
                        </div>
                    <?php endforeach ?>
                </div>
